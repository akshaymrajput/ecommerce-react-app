              ...
              onClick={() =>
                dispatch(
                  addToCart({
                    ...
                    title: currentProductData?.attributes?.title,
                    desc: currentProductData?.attributes?.desc,
                    price: currentProductData?.attributes?.price,
                    img1:
                      upload +
                      currentProductData?.attributes?.img1?.data?.attributes
                        ?.url,
                    quantity,
                  })
                )
